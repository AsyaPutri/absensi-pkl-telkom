...
// ===========================
// 📋 Ambil Data Lengkap dari cp_karyawan berdasarkan email
// ===========================
$mentor_query = mysqli_query($koneksi, "SELECT * FROM cp_karyawan WHERE email='$email_user'");
  ...
  <style>
    ...
    * {margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif;}
    ...
    .profile-item {
      ...
      border-radius: 10px;
      padding: 15px;
      box-shadow: inset 0 0 6px rgba(196,30,58,0.1);
    }
    .profile-item span {
      color: #777;
      font-size: 13px;
    ...
    .card .icon{
      width: 65px; height: 65px; margin: 0 auto 20px; border-radius: 50%;
      background: #fff5f5; display: flex; align-items: center; justify-content: center;
    }
    .card:hover .icon{background: #c41e3a;}
    .card .icon svg{width: 35px; height: 35px; fill: #c41e3a; transition: 0.3s;}
    .card:hover .icon svg{fill: white;}
    .card-title{font-size: 14px; color: #777; text-transform: uppercase; margin-bottom: 8px;}
    .card-value{font-size: 38px; font-weight: 700; color: #c41e3a;}
...
<body>
  ...
  <div class="profile-box">
    ...
    <div class="profile-grid">
      <div class="profile-item"><span>Nama Lengkap</span><strong><?php echo htmlspecialchars($nama_karyawan); ?></strong></div>
      <div class="profile-item"><span>Email</span><strong><?php echo htmlspecialchars($email); ?></strong></div>
      <div class="profile-item"><span>NIK</span><strong><?php echo htmlspecialchars($nik); ?></strong></div>
      <div class="profile-item"><span>No. HP</span><strong><?php echo htmlspecialchars($no_hp); ?></strong></div>
      <div class="profile-item"><span>Posisi</span><strong><?php echo htmlspecialchars($posisi); ?></strong></div>
    </div>
  </div>
